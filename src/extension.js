...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('sprint-ai.showWebview', () => {
        const panel = vscode.window.createWebviewPanel('webview', 'Settings Page', vscode.ViewColumn.One, { enableScripts: true });
...
function getWebviewContent(baseUri, cspSource, styleUri, scriptUri) {
